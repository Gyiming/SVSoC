...
def main():
    ...
    if multi == 32768:
        ...
        conf.set("info","latency_gpu","434")
        conf.set("info","energy_gpu","30")
    ...
    if multi == 369664:
        ...
        conf.set("info","latency_accelerator","172.5")
        conf.set("info","energy_accelerator","20.6")
        conf.set("info","latency_gpu","619")
        conf.set("info","energy_gpu","134")
        conf.set("info","latency_dsp","742.8")
        conf.set("info","energy_dsp","113.8")
