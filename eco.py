...
def main():
    ...
    if multi == 369664:
        ...
        conf.set("info","CPU1_enable","1")
        conf.set("info","latency_accelerator","83")
        conf.set("info","energy_accelerator","117.6")
        conf.set("info","latency_gpu","83.1")
        conf.set("info","energy_gpu","117.7")
        conf.set("info","latency_dsp","83.2")
        conf.set("info","energy_dsp","117.7")
        conf.set("info","latency_cpu1","83.3")
        conf.set("info","energy_cpu1","117.7")
        conf.set("info","latency_npu1","26")
        conf.set("info","energy_npu1","2.7")
        conf.set("info","latency_npu2","24")
        conf.set("info","energy_npu2","2.7")
